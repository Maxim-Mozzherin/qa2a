...
Тебе передана отдельная страница (страница 2 или далее) из общего документа.
Шапку документа (поставщика, покупателя, номер и дату) искать НЕ НУЖНО — они уже известны из первой страницы.
