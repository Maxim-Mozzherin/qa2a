...
function renderTable(data) {
    ...
    data.items.forEach((item, idx) => {
        ...
        // When Qty or Price changes -> Recalculate Sum
        ...
        const recalcFromSum = () => {
            ...
            aiPriceInput.value = p.toFixed(4); // Keep 4 decimals for price precision
        ...
        multInput.addEventListener('input', recalcFromQtyPrice);
